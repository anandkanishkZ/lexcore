...
import { deleteAdminUserAction } from "@/lib/actions/admin-user";
...
export default function DeleteUserModal({ userId, name, onClose, onSuccess }: DeleteUserModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div className="w-full max-w-sm rounded-2xl bg-white shadow-xl p-5">
                ...
                <p className="text-sm text-slate-600">
                    Are you sure you want to delete <span className="font-medium text-slate-900">{name}</span>? This
