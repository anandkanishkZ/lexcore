...
export default function DeleteTaskModal({ taskId, title, onClose, onSuccess }: DeleteTaskModalProps) {
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
            <div className="w-full max-w-sm rounded-2xl bg-white shadow-xl p-5">
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <h2 className="text-sm font-semibold text-slate-900">Delete task</h2>
                </div>
